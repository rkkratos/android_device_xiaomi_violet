...
git clone https://gitlab.com/Joker-V2/vendor_xiaomi-firmware_violet.git -b 15 vendor/xiaomi-firmware/violet
...
git clone https://github.com/ProjectPixelage/android_hardware_xiaomi.git -b 15 hardware/xiaomi
